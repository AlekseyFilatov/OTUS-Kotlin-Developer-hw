...
import api.kotlinproject.homeworkdsl.SqlSelectBuilder
import api.kotlinproject.homeworkdsl.query
...
class Hw1Sql {
    ...
    private fun checkSQL(expected: String, sql: SqlSelectBuilder) {
        assertEquals(expected = expected, actual = sql.build().toString())
    }
