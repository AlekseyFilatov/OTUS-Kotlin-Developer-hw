...
import api.kotlinproject.biz.trainmodel.initAnalyticTrainModel
import api.kotlinproject.biz.trainmodel.trainModelTrainResult
...
class MdlMlAnalyticProcessor(
    ...
    private val businessChain = rootChain<MdlContext> {
        ...
        initAnalyticTrainModel("Инициализация модели машинного обучения")
        ...
        operation("Запрос analytic", MdlCommand.ANALITYCML) {
            ...
            validation {
                ...
                worker("Копируем поля в mlAnalyticValidating") { mlAnalyticValidating.modelParameters = mlAnalyticMl.modelParameters.deepCopy() }
            ...
            training {
                ...
                trainModelTrainResult("Тренировка модели перед сохранением в БД")
            }
            chain {
