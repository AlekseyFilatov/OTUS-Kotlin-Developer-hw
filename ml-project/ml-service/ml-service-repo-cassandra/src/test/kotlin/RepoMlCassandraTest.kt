...
import api.kotlinproject.backend.repo.tests.RepoMlCreateTest
import api.kotlinproject.backend.repo.tests.RepoMlDeleteTest
import api.kotlinproject.backend.repo.tests.RepoMlReadTest
import api.kotlinproject.backend.repo.tests.RepoMlUpdateTest
...
class CassandraTest {
    ...
    class RepoMlCassandraCreateTest : RepoMlCreateTest() {
    ...
    class RepoMlCassandraReadTest : RepoMlReadTest() {
        override val repo = MlRepoInitialized(
            initObjects = initObjects,
            repo = repository()
        )
